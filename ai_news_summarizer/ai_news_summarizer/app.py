...
def summarize_news_json(req: SummarizeRequest):
    """Summarize news URL via JSON API"""
    try:
        # For now, return a simple response to the test
        prompt = f"Summarize the article from: {req.url}"
